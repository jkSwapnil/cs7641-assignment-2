"""
This module implements the optimization for FourPeaks problems using the following RO algorithms
...
RESULT_DIR = "./results/four_peaks"
PLOT_DIR = "./plots/four_peaks"


def fitness_vs_iteration_analysis():
    """ Plot fitness values vs iterations for the FourPeaks problem.
...
def full_sa_fitness_vs_iteration_analysis():
    """ Plot fitness values vs iterations for the FourPeaks problem using full Simulated Annealing.
...
def scalability_analysis():
    """ Perform scalability analysis of FourPeaks problem.

    Imp points:
        - Increase the problem size FourPeaks in the step of 10
