"""
This module implements the optimization for FlipFlop problems using the following RO algorithms
...
RESULT_DIR = "./results/flip_flop"
PLOT_DIR = "./plots/flip_flop"


def fitness_vs_iteration_analysis():
    """ Plot fitness values vs iterations for the FlipFlop problem.
    ...
    n = 100  # Size of the problem (length of the input state)
    ...
    fitness = mlrose.FlipFlop()  # Create the fitness function object
...
def scalability_analysis():
    """ Perform scalability analysis of FlipFlop problem.

    Imp points:
        - Increase the problem size FlipFlop in the step of 10
    ...
    for n in tqdm(range(10, 120, 10)):
        ...
        for trail in range(5):
            ...
            _, sa_best_fitness, sa_fitness_vs_iter_curve = mlrose.simulated_annealing(
                problem=problem, schedule=schedule, max_attempts=max_attempts, max_iters=max_iters, curve=True, 
